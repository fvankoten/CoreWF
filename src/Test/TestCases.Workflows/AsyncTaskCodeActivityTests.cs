...
namespace TestCases.Activities
{
    ...
    public class AsyncTaskActivity : AsyncTaskCodeActivity
    {
        ...
        protected override Task ExecuteAsync(AsyncCodeActivityContext context, object state, CancellationToken cancellationToken) => _action(cancellationToken);
    }
    public class AsyncTaskActivity<TResult> : AsyncTaskCodeActivity<TResult>
    {
        ...
        protected override Task<TResult> ExecuteAsync(AsyncCodeActivityContext context, object state, CancellationToken cancellationToken) => _action(cancellationToken);
    }
}